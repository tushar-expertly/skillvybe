    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            At Skillvybe, we are dedicated to safeguarding your privacy and
            ...
            existing agreements directly established between you and Skillvybe.
          ...
          <p className="mb-4">
            At Skillvybe, we will only request personal information when it is
          ...
          <p className="mb-4">
            In the event that Skillvybe invites you to complete and submit an
          ...
          <p className="mb-4">
            It's important to note that while Skillvybe may track a visitor's
          ...
          <p className="mb-4">
            The purposes for which Skillvybe may utilize your personal
          ...
          <p className="mb-4">
            If you wish to be removed from any Skillvybe distribution list,
          ...
          <p className="mb-4">
            ...
            Skillvybe, you may receive telephone calls from us regarding new
          ...
          <p className="mb-4">
            The Skillvybe website may contain links to external websites,
            ...
            are not governed by Skillvybe's privacy policy. Skillvybe has no
          ...
          <p className="mb-4">
            ...
            Skillvybe's privacy practices and does not extend to the privacy
            policies or practices of third-party websites or features.
            Skillvybe cannot be held responsible for the privacy policies
          ...
          <p className="mb-4">
            ...
            paramount at Skillvybe. We have implemented robust measures to
          ...
          <p className="mb-4">
            At Skillvybe, we remain committed to upholding the highest
          ...
          <p className="mb-4">
            ...
            Skillvybe remains fully compliant with the EU-US Privacy Shield
          ...
          <p className="mb-4">
            At Skillvybe, we are committed to maintaining the highest standards
          ...
          <p className="mb-4">
            Skillvybe is mandated to adhere to specific procedures when
          ...
          <p className="mb-4">
            In accordance with the Privacy Shield Principles, Skillvybe is
          ...
          <p className="mb-4">
            Skillvybe is subject to the investigative and enforcement authority
          ...
          <p className="mb-4">
            Skillvybe reserves the right to modify or supplement this Privacy
            Policy at its discretion. We encourage you to periodically review
            this section of Skillvybe’s website to stay informed of any
