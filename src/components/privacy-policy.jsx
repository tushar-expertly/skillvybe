    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            At Theprofess, we are dedicated to safeguarding your privacy and
            ...
            existing agreements directly established between you and Theprofess.
          ...
          <p className="mb-4">
            At Theprofess, we will only request personal information when it is
          ...
          <p className="mb-4">
            In the event that Theprofess invites you to complete and submit an
          ...
          <p className="mb-4">
            It's important to note that while Theprofess may track a visitor's
          ...
          <p className="mb-4">
            The purposes for which Theprofess may utilize your personal
          ...
          <p className="mb-4">
            If you wish to be removed from any Theprofess distribution list,
          ...
          <p className="mb-4">
            ...
            Theprofess, you may receive telephone calls from us regarding new
          ...
          <p className="mb-4">
            The Theprofess website may contain links to external websites,
            ...
            are not governed by Theprofess's privacy policy. Theprofess has no
          ...
          <p className="mb-4">
            ...
            Theprofess's privacy practices and does not extend to the privacy
            policies or practices of third-party websites or features.
            Theprofess cannot be held responsible for the privacy policies
          ...
          <p className="mb-4">
            ...
            paramount at Theprofess. We have implemented robust measures to
          ...
          <p className="mb-4">
            At Theprofess, we remain committed to upholding the highest
          ...
          <p className="mb-4">
            ...
            Theprofess remains fully compliant with the EU-US Privacy Shield
          ...
          <p className="mb-4">
            At Theprofess, we are committed to maintaining the highest standards
          ...
          <p className="mb-4">
            Theprofess is mandated to adhere to specific procedures when
          ...
          <p className="mb-4">
            In accordance with the Privacy Shield Principles, Theprofess is
          ...
          <p className="mb-4">
            Theprofess is subject to the investigative and enforcement authority
          ...
          <p className="mb-4">
            Theprofess reserves the right to modify or supplement this Privacy
            Policy at its discretion. We encourage you to periodically review
            this section of Theprofess’s website to stay informed of any
